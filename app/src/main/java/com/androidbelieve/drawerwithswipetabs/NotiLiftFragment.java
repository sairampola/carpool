 ...
 */
public class NotiLiftFragment extends Fragment {

    private static final String TAG = "Cap";

    // Movies json url
    private static final String url = AGlobal.url+"notiliftresponse";
    private ProgressDialog pDialog;
    private final List<NotiPickupResults> movieList = new ArrayList<NotiPickupResults>();
    private ListView listView;
    private  NotiLiftListAdapter adapter;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.noti_lift_layout,null);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new NotiLiftListAdapter(getActivity(), movieList,getContext(),getFragmentManager());
        ...
        StringRequest movieReq = new StringRequest(Request.Method.POST,url,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("Aemail", prefs.getString("email",null));
