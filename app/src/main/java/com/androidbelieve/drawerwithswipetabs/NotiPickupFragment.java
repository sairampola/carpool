 ...
 */
public class NotiPickupFragment extends Fragment {
    ...
    // Movies json url
    private static final String url = AGlobal.url+"notipickupresponse";
    private ProgressDialog pDialog;
    private final List<NotiPickupResults> movieList = new ArrayList<NotiPickupResults>();
    private ListView listView;
    private  NotiPickupListAdapter adapter;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.noti_pickup_layout, null);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new NotiPickupListAdapter(getActivity(), movieList,getContext(),getFragmentManager());
        ...
        StringRequest movieReq = new StringRequest(Request.Method.POST,url,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("Bemail", prefs.getString("email",null));
